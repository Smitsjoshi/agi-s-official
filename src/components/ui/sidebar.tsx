  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[--sidebar-width] flex-col bg-sidebar/80 text-sidebar-foreground backdrop-blur-sm",
            className
          )}
          ref={ref}
          {...props}
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar/60 backdrop-blur-sm group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
...
>(
  (
    ...
    const tooltipContentProps = React.isValidElement(tooltip) ? (tooltip.props as React.ComponentProps<typeof TooltipContent>) : (tooltip as React.ComponentProps<typeof TooltipContent>)
    const tooltipContent = React.isValidElement(tooltip) ? tooltip.props.children : tooltip
